...
TITLE = "Corpus from confirmed CV facts"
...
# Where a fact with no role goes. A fact confirmed against a role is filed
# under the role's own label instead, so `section_path` carries the employer
# and title into the gate's view of the corpus -- "Led a team of six" is a very
# different claim under one role than under another, and the breadcrumb is what
# the gate sees.
